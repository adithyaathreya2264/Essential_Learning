...
/** Cross-chapter aggregate review session, entered from the Due Today tab. */
  ...
  if (session.done) {
    return (
      <View style={{ flex: 1, backgroundColor: tokens.background, padding: spacing.lg, justifyContent: 'center', alignItems: 'center' }}>
        ...
        >
          <Text style={[styles.ctaText, { fontFamily: fonts.uiMedium }]}>Done</Text>
        </Pressable>
      </View>
    );
  }
